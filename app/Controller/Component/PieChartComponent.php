...
class PieChartComponent extends Component{
    ...
    function initialize(&$controller) {
        $this->Chart->setProperty('cht', 'p');
		$this->Chart->setDimensions($width = 350, $height = 200);
    }
    */
    
    /*  # cakephp parece não aceitar dentro de um construct o uso de um método definido em uma outra classe
	function __construct($width = 350, $height = 200) {
        $this->Chart->setProperty('cht', 'p');
		$this->Chart->setDimensions($width, $height);
    }
    */
