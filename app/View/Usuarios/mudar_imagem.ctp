    ...
    <?php   echo $this->Form->create('Usuario', array('type' => 'file')); ?>
        ...
        <fieldset>
            <legend><?php echo __('Escolha uma nova imagem para seu perfil');?></legend>
        <?php
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                url: '<?php echo $this->Html->url(array("controller" => "usuarios","action" => "imageResponseP"));?>',
                cache: false,
                type: 'GET',
            ...
            $.ajax({
                url: '<?php echo $this->Html->url(array("controller" => "usuarios","action" => "imageResponseT"));?>',
                cache: false,
                type: 'GET',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                beforeSend: function(){
