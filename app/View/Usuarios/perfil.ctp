                ...
                <div id="UserInfo">
                    ...
                    <span class="userInfoLabel">
                        ...
                        <?php   echo $this->Html->link('EDITAR',
                                            '#javascript:;',
                                            array('onclick' => 'insereInput(\'Name\',\''.addslashes($this->Session->read('Auth.Usuario.nome')).'\')',
                    ...
                    <span class="userInfoLabel">
                        ...
                        <?php   echo $this->Html->link('EDITAR',
                                            '#javascript:;',
                                            array('onclick' => 'insereInput(\'Email\',\''.$this->Session->read('Auth.Usuario.email').'\')',
                                                  'class' => 'btneditar right')); ?>
                    </span>
                    ...
                    <p class="profile">
                        <?php   echo $this->Session->read('Auth.Usuario.login'); ?>
                    </p>
